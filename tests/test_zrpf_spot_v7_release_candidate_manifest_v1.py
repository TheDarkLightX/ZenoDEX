...
EXPECTED_FIXTURE_BYTES = 9_589
EXPECTED_FIXTURE_SHA256 = "b6e4e4592a6dd8602739ddf3e89f2d0e88ee5664de7ee890fb96c6c6841e73a1"
EXPECTED_CANDIDATE_ID = "404d724f362dfd4585fbd0415cb49cae01ab802f4eaf6ff5919abf9fd7047992"
    ...
    return [
        {
            ...
            "role": role,
            "sha256": _position_digest(index + 1),
...
def _body() -> dict[str, Any]:
    ...
    digest_by_role = {row["role"]: row["sha256"] for row in inventory}
    return {
        ...
        "runtime": {
            ...
            "root_supervisor_executable_sha256": digest_by_role[
        ...
        "scope": {
            ...
            "receipt_security_profile_sha256": digest_by_role[
...
def test_position_distinct_fixture_recomposes_and_remains_authority_false() -> None:
    ...
    digests = [bytes.fromhex(cast(str, row["sha256"])) for row in _inventory()]
...
def test_inventory_role_order_codec_aliasing_and_wrong_field_digest_reject() -> None:
    ...
    alias = _body()
    alias["evidence_inventory"][1]["sha256"] = alias["evidence_inventory"][0]["sha256"]
    with pytest.raises(candidate.SpotV7ReleaseCandidateRejectV1) as captured:
