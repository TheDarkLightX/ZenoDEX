...
def test_create_pool_intent_propagates_unexpected_asset_normalizer_error(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    def boom(_asset0: object, _asset1: object) -> tuple[str, str]:
        raise RuntimeError("asset normalizer bug")

    monkeypatch.setattr(intents_module, "normalize_pool_asset_pair", boom)
