...
def test_release_gate_runs_production_key_management_checks() -> None:
    ...
    assert "tools/check_production_key_management_completion.py" in release_gate
    ...
    assert "tests/test_check_production_key_management_completion.py" in release_gate
