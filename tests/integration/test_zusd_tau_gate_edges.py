...
def test_zusd_tau_gate_single_checks_cover_all_guard_builders() -> None:
    ...
    minted = _single_ok(funded, "mint_zusd", amount_e8=120 * E8)
    ...
    pending = _single_ok(
        _single_ok(_single_ok(minted, "deposit_sp", amount_e8=120 * E8), "oracle_report", price_e8=40 * E8, auth_ok=True),
        "advance_epoch",
        delta=1,
    )
...
def test_zusd_tau_gate_multi_helpers_and_checks_cover_all_paths() -> None:
    ...
    minted_a = _multi_ok(funded, "mint_zusd", vault="a", amount_e8=120 * E8)
