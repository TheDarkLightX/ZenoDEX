...
def test_tau_net_settlement_signer_registry_loader_rejects_missing_state_proof_view_contract(
...
def test_tau_net_settlement_signer_registry_loader_rejects_missing_tau_state_view_contract(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    _require_blake3()
    attestation = _attestation()
