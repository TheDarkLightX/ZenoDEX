...
def test_quote_receipt_boundary_concolic_discovers_reject_paths() -> None:
    ...
    assert report.unique_path_count >= 35
...
def test_confidential_receipt_boundary_concolic_discovers_reject_paths() -> None:
    ...
    assert report.unique_path_count >= 55
...
def test_receipt_boundary_concolic_all_targets_are_covered() -> None:
    ...
    assert by_name["quote_receipt_verify"].total_cases >= 35
    assert by_name["quote_receipt_verify_exact_in_certificate"].total_cases >= 10
    assert by_name["confidential_receipt_verify"].total_cases >= 55
