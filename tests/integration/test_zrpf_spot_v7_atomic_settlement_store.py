...
def test_governed_firecracker_authority_reports_the_exact_fail_closed_frontier() -> None:
    assert SPOT_V7_FIRECRACKER_AUTHORITY_MISSING_CONDITIONS_V1 == (
        ...
        SpotV7FirecrackerAuthorityMissingConditionV1.SPOT_V7_PID1_GUEST_AND_INPUT_IMAGE,
        SpotV7FirecrackerAuthorityMissingConditionV1.SPOT_V7_GOVERNED_RAW_OUTPUT_PROFILE,
        SpotV7FirecrackerAuthorityMissingConditionV1.SPOT_V7_GOVERNED_RUNTIME_MANIFEST,
        ...
        SpotV7FirecrackerAuthorityMissingConditionV1.GOVERNED_RUNNER_RESULT_CAPABILITY,
