...
def test_perp_tau_ingress_schema_guard_v1_trace() -> None:
    ...
    steps = [
        # signed action with valid auth bundle => accept
        {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 1, "i6": 1, "i7": 1, "i8": 0, "i9": 1, "i10": 0, "i11": 1},
        # oracle action with valid auth bundle => accept
        {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 1, "i6": 1, "i7": 0, "i8": 1, "i9": 0, "i10": 1, "i11": 1},
        # signed action missing the signed auth bundle => reject
        {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 1, "i6": 1, "i7": 1, "i8": 0, "i9": 0, "i10": 0, "i11": 1},
        # oracle action missing the oracle auth bundle => reject
        {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 1, "i6": 1, "i7": 0, "i8": 1, "i9": 0, "i10": 0, "i11": 1},
        # action selection is not one-hot => reject
        {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 1, "i6": 0, "i7": 1, "i8": 0, "i9": 1, "i10": 0, "i11": 1},
        # host projection failed => reject
        {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 1, "i6": 1, "i7": 1, "i8": 0, "i9": 1, "i10": 0, "i11": 0},
        # unknown fields survive projection => reject
        {"i1": 1, "i2": 1, "i3": 1, "i4": 0, "i5": 1, "i6": 1, "i7": 1, "i8": 0, "i9": 1, "i10": 0, "i11": 1},
        # no supported action => reject
        {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 0, "i6": 0, "i7": 0, "i8": 0, "i9": 0, "i10": 0, "i11": 1},
    ]
