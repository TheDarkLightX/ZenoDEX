...
def test_perp_tau_ingress_schema_guard_v1_trace() -> None:
    ...
    steps = [
        # Signed action with all host-projected facts present.
        {
            "i1": 1,
            "i2": 1,
            "i3": 1,
        ...
        # Oracle action with all host-projected facts present.
        {
            "i1": 1,
            "i2": 1,
            "i3": 1,
        ...
        # Unknown or non-one-hot action fails action selection.
        {
            "i1": 1,
            "i2": 1,
            "i3": 1,
        ...
        # Both auth modes selected fails closed.
        {
            "i1": 1,
            "i2": 1,
            "i3": 1,
        ...
        # Host projection failure blocks the aggregate gate.
        {
            "i1": 1,
            "i2": 1,
            "i3": 1,
