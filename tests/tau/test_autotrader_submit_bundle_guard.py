...
SPEC_PATH = Path("src/tau_specs/recommended/autotrader_submit_bundle_guard_v1.tau")


def test_autotrader_submit_bundle_guard_traces() -> None:
    ...
    outputs = run_tau_spec_steps_spec_mode(
        ...
        steps=[
            ...
            {"i1": 1, "i2": 1, "i3": 1, "i4": 1, "i5": 1, "i6": 1, "i7": 1, "i8": 1, "i9": 0},
            {"i1": 1, "i2": 0, "i3": 1, "i4": 1, "i5": 1, "i6": 1, "i7": 1, "i8": 0, "i9": 0},
