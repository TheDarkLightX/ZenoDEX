...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("meta", {"meta": {"post_app_hash": "22" * 32}}),
        ("operation_hash", {"operation_hash": "33" * 32}),
        ("receipt_root", {"receipt_root": "44" * 32}),
        ("proof_mode", {"proof_mode": "risc0"}),
        ("production_security_claim", {"production_security_claim": True}),
        ("expected_post_app_hash_enforced", {"expected_post_app_hash_enforced": True}),
        ("post_snapshot", {"post_snapshot": {"accepted": True}}),
        ("journal", {"journal": {"proof_type": diff.PERPS_NP_PROOF_TYPE}}),
        ...
        ("context.meta", {"context": {"meta": {"post_app_hash": "22" * 32}}}),
        ("context.operation_hash", {"context": {"operation_hash": "33" * 32}}),
        ("context.receipt_root", {"context": {"receipt_root": "44" * 32}}),
    ],
)
