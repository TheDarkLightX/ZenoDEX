...
MODEL = ROOT / "src" / "kernels" / "dex" / "settlement_attestation_policy_guard_v1.yaml"


@pytest.mark.skipif(importlib.util.find_spec("ESSO") is None, reason="ESSO is not available")
def test_esso_settlement_attestation_policy_guard_verifies() -> None:
    ...
    assert report["queries"]["inductive_rebuild_policy_guard"]["final_result"] == "unsat"
