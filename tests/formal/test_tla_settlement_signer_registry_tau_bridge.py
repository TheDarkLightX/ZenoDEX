...
MODEL = ROOT / "formal" / "tla" / "SettlementSignerRegistryTauBridge.tla"
CFG = ROOT / "formal" / "tla" / "SettlementSignerRegistryTauBridge.cfg"
...
def test_tla_settlement_signer_registry_tau_bridge_model_checks() -> None:
