...
CLAIMS = (
    ...
    "exact_freshness_boundary_allows_publication",
    "unseen_oracle_blocks_publication",
    "zero_index_blocks_publication",
    "stale_by_one_blocks_publication",
    "same_epoch_oracle_blocks_publication",
    "duplicate_epoch_publication_is_blocked",
    "non_open_phase_blocks_publication",
