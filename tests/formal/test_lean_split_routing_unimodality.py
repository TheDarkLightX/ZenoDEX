...
TARGET = "Proofs.SplitRoutingUnimodality"
...
def test_lean_split_routing_unimodality_builds_without_warnings() -> None:
...
def test_lean_split_routing_unimodality_exported_via_proofs_root() -> None:
    lake, lean_dir = _require_lake_and_mathlib()
    _ensure_proofs_root_built(lake, lean_dir)

    smoke = (
        "import Proofs\n"
        "#check Proofs.SplitRoutingUnimodality.discard_left\n"
        "#check Proofs.SplitRoutingUnimodality.discard_right\n"
        "#check Proofs.SplitRoutingUnimodality.near_unimodal_from_concave\n"
        "#check Proofs.SplitRoutingUnimodality.ternary_step_budget\n"
    )
