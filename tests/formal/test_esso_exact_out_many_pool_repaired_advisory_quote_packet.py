...
MODEL = ROOT / "src" / "kernels" / "dex" / "exact_out_many_pool_repaired_advisory_quote_packet_v1.yaml"


@pytest.mark.skipif(os.environ.get("ZENO_SKIP_ESSO") == "1", reason="ESSO checks disabled")
def test_esso_exact_out_many_pool_repaired_advisory_quote_packet_verifies() -> None:
