...
TARGET = "Proofs.CPMMSandwichCertificate"
...
def test_lean_cpmm_sandwich_certificate_builds_without_warnings() -> None:
...
def test_lean_cpmm_sandwich_certificate_exported_via_proofs_root() -> None:
    lake, lean_dir = _require_lake_and_mathlib()
    _ensure_proofs_root_built(lake, lean_dir)

    smoke = (
        "import Proofs\n"
        "#check Proofs.CPMMSandwich.cpmm_zero_fee_split_certificate_linear\n"
        "#check Proofs.CPMMSandwich.cpmm_zero_fee_split_certificate_combined\n"
        "#check Proofs.CPMMSandwich.witness_linear_scale_gap\n"
    )
