...
MODEL = ROOT / "formal" / "tla" / "TauStateAppHashStableWindow.tla"
CFG = ROOT / "formal" / "tla" / "TauStateAppHashStableWindow.cfg"
...
def test_tla_tau_state_app_hash_stable_window_model_checks() -> None:
