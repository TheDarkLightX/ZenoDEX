...
def test_stationary_m_certificate_path_file_typechecks() -> None:
    ...
    target = "Proofs/StationaryMCertificatePath.lean"
    if not (root / "external" / "mathlib4").exists():
        pytest.skip("mathlib4 checkout missing")

    source = (lean_dir / target).read_text(encoding="utf-8")
    required_theorems = (
        "asymmetric_stationary_m_soundness",
        "asymmetric_stationary_m_certificate_path",
        "symmetric_stationary_m_universal_floor",
        "symmetric_stationary_m_soundness",
        "symmetric_stationary_m_dominates_endpoint",
        "symmetric_stationary_m_certificate_path",
        "stationary_radius_le_interval_radius",
        "stationary_radius_le_endpoint_radius",
        "complete_stationary_certificate_soundness",
    )
