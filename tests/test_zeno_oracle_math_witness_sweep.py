...
def test_zeno_oracle_math_witness_sweep_accepts_expected_cases() -> None:
    ...
    assert "production_network_receipt_dependency_chain_accepts" in case_ids
    assert "production_network_receipt_dependency_chain_drift_rejects" in case_ids
...
def test_zenoproof_julia_replay_profile_minimum_tracks_witness_sweep() -> None:
    ...
    assert zenoproof_verify.MIN_JULIA_MATH_WITNESS_CASE_COUNT == 45
