...
MODEL = Path("src/kernels/dex/fire_lp_loss_cover_v1.yaml")
ADAPTER = "src.fire.runtime.lp_loss_cover_v1_native_adapter:make_simulation_adapter"
...
def _receipt_for_bundle(
    ...
    *,
    ...
    return FireVerifierReceipt.build(
        ...
        witness_hash=fire_witness_binding_hash(
            {
...
def test_fire_lp_loss_cover_native_adapter_shell_lint_and_verify(tmp_path: Path) -> None:
...
def test_fire_lp_loss_cover_native_adapter_unknown_action(monkeypatch) -> None:
...
def test_fire_lp_loss_cover_native_adapter_accepts_persisted_bundle(monkeypatch, tmp_path: Path) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.lp_loss_cover_v1_native_adapter import make_adapter
...
def test_fire_lp_loss_cover_native_adapter_rejects_missing_persisted_bundle_receipt(
...
def test_fire_lp_loss_cover_native_adapter_rejects_missing_persisted_bundle_dir(monkeypatch) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.lp_loss_cover_v1_native_adapter import make_adapter
...
def test_fire_lp_loss_cover_native_adapter_rejects_witness_binding_mismatch(
    monkeypatch, tmp_path: Path
) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.lp_loss_cover_v1_native_adapter import make_adapter
...
def test_fire_lp_loss_cover_native_adapter_rejects_bad_persisted_bundle_hash(
    monkeypatch, tmp_path: Path
) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.lp_loss_cover_v1_native_adapter import make_adapter
