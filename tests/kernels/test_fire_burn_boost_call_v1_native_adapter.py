...
MODEL = Path("src/kernels/dex/fire_burn_boost_call_v1.yaml")
ADAPTER = "src.fire.runtime.burn_boost_call_v1_native_adapter:make_simulation_adapter"
...
def test_fire_burn_boost_call_native_adapter_shell_lint_and_verify(tmp_path: Path) -> None:
...
def test_fire_burn_boost_call_native_adapter_unknown_action(monkeypatch) -> None:
...
def test_fire_burn_boost_call_native_adapter_rejects_non_string_command_tag(monkeypatch) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.burn_boost_call_v1_native_adapter import make_adapter
...
def test_fire_burn_boost_call_native_adapter_guard_false(monkeypatch) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.burn_boost_call_v1_native_adapter import make_adapter
...
def test_fire_burn_boost_call_native_adapter_accepts_persisted_bundle(monkeypatch, tmp_path: Path) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.burn_boost_call_v1_native_adapter import make_adapter
...
def test_fire_burn_boost_call_native_adapter_rejects_non_bool_firev_accept_effect(
    monkeypatch,
    tmp_path: Path,
) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    import src.fire.runtime.burn_boost_call_v1_native_adapter as adapter_mod
...
def test_fire_burn_boost_call_native_adapter_rejects_missing_persisted_bundle_receipt(
...
def test_fire_burn_boost_call_native_adapter_rejects_missing_persisted_bundle_dir(monkeypatch) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.burn_boost_call_v1_native_adapter import make_adapter
...
def test_fire_burn_boost_call_native_adapter_rejects_tampered_persisted_bundle_receipt(
    monkeypatch, tmp_path: Path
) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.burn_boost_call_v1_native_adapter import make_adapter
    ...
    assert isinstance(result, interp_mod.StepError)
    assert result.code == "GuardFalse"
    assert "holder_delta_mismatch" in result.message


def test_fire_burn_boost_call_native_adapter_rejects_witness_binding_mismatch(
    monkeypatch, tmp_path: Path
) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.burn_boost_call_v1_native_adapter import make_adapter
...
def test_fire_burn_boost_call_native_adapter_rejects_bad_persisted_bundle_hash(
    monkeypatch, tmp_path: Path
) -> None:
    interp_mod = _install_fake_interpreter(monkeypatch)
    from src.fire.runtime.burn_boost_call_v1_native_adapter import make_adapter
