...
def test_default_recursive_stark_cbc_matrix_accepts_and_preserves_non_claims() -> None:
    ...
    assert report["matrix_sha256"] == (
        "sha256:f428a09d24297ba0c0f6614a85cf3a85328361d993f31fb620b7498140f5a4e0"
    )
...
def test_current_recursive_proof_status_rejects_stale_proof_absence_nonclaim() -> None:
    matrix = _matrix()
