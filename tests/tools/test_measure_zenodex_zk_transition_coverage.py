...
def test_zk_transition_coverage_reports_current_scope() -> None:
    ...
    assert report["proof_substrate_obligations"]["ok"] is True
    assert report["proof_substrate_obligations"]["proof_gap_obligation_count"] == 7
    assert report["proof_substrate_obligations"]["tau_guard_gap_count"] == 5
    assert report["proof_substrate_obligations"]["tau_closed_real_proof_gap_count"] == 0
