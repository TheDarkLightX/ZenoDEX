...
def test_action_bound_rejects_int_subclass_domain():
    class WeirdInt(int):
        pass

    assert not gov_gate.action_bound_ok(True, True, 0, MD, MD, WeirdInt(500), 550, 0, 1000, 50)
...
def test_master_rejects_duck_typed_revision():
    # A duck-typed object with property-backed fields could otherwise return exec_req=True
    # during flag validation and exec_req=False at the escape branch.
    class FlipExec:
        def __init__(self):
            self._n = 0
