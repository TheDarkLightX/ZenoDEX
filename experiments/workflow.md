...
- `AdaptiveBernsteinRegionCertificates.lean` now proves arbitrary-degree
  ...
  invariance, recursive de Casteljau scalar evaluation, and adaptive-cover
  lifting. The Julia compiler has 12 exact differential checks. Its remaining
  Lean gaps are power-to-Bernstein conversion and the full affine theorem that
  binds emitted left/right subdivision coefficients to reparameterized
  subinterval polynomials.
