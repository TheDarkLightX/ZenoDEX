...
TASK_SPECS = (
    ...
    TaskSpec(
        "worker_prover_build",
        ("ancestry_materialization",),
        ("post_pin_governance_result", "r0vm"),
        (
            "v2_adapter_prover",
            "v6_leaf_prover",
            "v6_l1_prover",
        ...
        (
            "two clean no-network builds execute at exact G",
            "all nine worker artifacts occupy exact position-distinct roles",
            "V7 program image ID is recomputed by the packet-pinned r0vm",
            "candidate build report binds every emitted artifact and keeps authority false",
        ),
        "cpu_high_memory",
        execution_adapter_status="implemented",
    ),
