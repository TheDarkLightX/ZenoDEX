...
ARTIFACT_SPECS = (
    ...
    ArtifactSpec(
        "v6_l1_seal_mutation", "mutations/v6_l1.json", "mutated_receipt", "mutation_verification"
    ),
    ArtifactSpec(
        "v6_l2_seal_mutation", "mutations/v6_l2.json", "mutated_receipt", "mutation_verification"
    ),
    ArtifactSpec("mutation_report", "mutations/report.json", "report", "mutation_verification"),
