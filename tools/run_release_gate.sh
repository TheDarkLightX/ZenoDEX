...
"$PY" "$ROOT_DIR/tools/check_zenodex_proof_substrate_obligations.py"
"$PY" "$ROOT_DIR/tools/check_zenodex_transition_profile_closure.py"
"$PY" "$ROOT_DIR/tools/check_zenodex_critical_value_surface_inventory.py"
...
"$PY" -m pytest -q \
  ...
  "$ROOT_DIR/tests/tools/test_check_zenodex_proof_substrate_obligations.py" \
  "$ROOT_DIR/tests/tools/test_check_zenodex_transition_profile_closure.py" \
  "$ROOT_DIR/tests/tools/test_check_zenodex_critical_value_surface_inventory.py" \
