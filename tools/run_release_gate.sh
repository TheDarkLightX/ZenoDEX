...
echo "== release: external toolchain preflight =="
"$PY" "$ROOT_DIR/tools/check_release_external_toolchains.py"
...
"$PY" -m py_compile \
  ...
  "$ROOT_DIR/tools/check_production_key_management_completion.py" \
  ...
  "$ROOT_DIR/tests/test_check_production_key_management_completion.py"
...
"$PY" "$ROOT_DIR/tools/check_zeno_ledger_dynamic_peers.py"
...
"$PY" -m py_compile \
  ...
  "$ROOT_DIR/tools/check_zeno_ledger_dynamic_peers.py" \
  ...
  "$ROOT_DIR/tests/integration/test_zeno_ledger_dynamic_peer_exchange_v0.py" \
