...
EXPECTED_LEAN_PROOFS: dict[str, dict[str, Any]] = {
    "nonce_batch_wrapper_lean": {
        ...
        "required_theorems": [
            ...
            "Proofs.ZenoDEX.NonceBatchWrapper.acceptsSortedFold_eq_successorRange",
            "Proofs.ZenoDEX.NonceBatchWrapper.acceptsSortedFold_final_eq_start_add_length",
            "Proofs.ZenoDEX.NonceBatchWrapper.batch_accept_decision_implies_safety",
            "Proofs.ZenoDEX.NonceBatchWrapper.batch_accept_decision_implies_exact_ranges",
            "Proofs.ZenoDEX.NonceBatchWrapper.batch_accept_decision_implies_group_nodup",
            "Proofs.ZenoDEX.NonceBatchWrapper.group_accept_decision_implies_exact_range",
