...
This verifier accepts only local fixture proofs for the live zUSD/perps wrapper
request schema, then echoes the request hash and artifact binding required by
the runtime gate. It is testnet evidence, not production proof evidence.
"""
