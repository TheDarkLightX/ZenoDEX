#!/usr/bin/env python3
"""
Reference proof producer for the recompute-batch scheme (v3, projected witness).

Like v2, but:
  - pre_state_commitment is a *support root* (projected state commitment), and
  - the embedded snapshot witness is projected to the batch's support.
...
Output (stdout): proof object to attach under operations["3"]["proof"].
"""
