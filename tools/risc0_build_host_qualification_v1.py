...
IMMUTABLE_BOOTSTRAP_PREREQUISITE_V1: Final = "EXTERNAL_PINNED_LAUNCHER_REQUIRED"
...
def _resource_status_v1(resource: ResourceObservationV1 | None) -> str:
    ...
    if resource.free_tmp_bytes is None or resource.available_memory_bytes is None:
        return "BLOCKED_RESOURCE_EVIDENCE_INSUFFICIENT"
    if resource.free_tmp_bytes < 50 * 1024 * 1024 or resource.available_memory_bytes < 128 * 1024 * 1024:
...
def _resource_projection_v1(
    ...
    common: dict[str, object] = {
        ...
        "minimum_available_memory_bytes": 128 * 1024 * 1024,
        "minimum_tmp_free_bytes": 50 * 1024 * 1024,
    ...
    *,
    ...
    artifact: dict[str, object] = {
        ...
        "trust_nonclaims": {
            ...
            "immutable_checker_bootstrap": IMMUTABLE_BOOTSTRAP_PREREQUISITE_V1,
