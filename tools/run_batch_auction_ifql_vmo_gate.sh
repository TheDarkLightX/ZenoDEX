...
BASE_CONTRACT="$ROOT_DIR/runs/batch_auction_compass_contract_v7.json"
INTENT_LATTICE="$ROOT_DIR/tools/intent_lattices/batch_auction_v7_observation_intent.json"
REF_MODEL="$ROOT_DIR/runs/compass_build_v5/compiled/modules/batch_settler/model.yaml"
CAND_MODEL="$ROOT_DIR/runs/compass_build_v7/compiled/modules/batch_settler/model.yaml"
