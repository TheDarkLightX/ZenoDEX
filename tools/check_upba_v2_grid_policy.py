...
def sample_policy() -> dict[str, Any]:
    policy: dict[str, Any] = {
        ...
        "grid_max_price_num": 50,
        "grid_max_price_den": 20,
        "economic_price_scale": 20,
        "economic_min_price_scaled": 40,
        "economic_max_price_scaled": 50,
        "economic_tick_size_scaled": 1,
        "rounding_loss_atoms": 4,
        "max_absolute_loss_atoms": 2_600,
        "min_notional_output_atoms": 7_000,
        "max_relative_loss_ppm": 400_000,
        "max_candidate_evaluations": 700_000,
