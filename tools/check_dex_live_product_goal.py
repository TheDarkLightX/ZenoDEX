...
RESIDUAL_LIMITS: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "description": "Hardware/OS signer-device integration and guardian signature verification remain open; public recovery threshold/delay and rotation-broadcast exercises now have receipts.",
    },
    {
        "id": "zk_wrapping",
