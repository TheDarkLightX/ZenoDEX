...
PUBLIC_SCOPE_GLOBS: tuple[str, ...] = (
    ...
    "generated/derivatives_python/funding_rate_market_v1_1_ref.py",
    ...
    "src/tau_specs/recommended/*.tau",
    "src/tau_specs/recommended/README.md",
    ...
    "tests/tau/FORMAL_COMPLETENESS.md",
    "tests/tau/spec_registry.json",
    ...
    "tools/run_snapshot_recovery_gate.sh",
