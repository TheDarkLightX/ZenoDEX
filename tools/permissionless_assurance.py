...
PUBLIC_SCOPE_GLOBS: tuple[str, ...] = (
    ...
    "docs/ZENODEX_BATCH_PROOF_COVERAGE_V0.json",
    "docs/ZENODEX_HOST_INDEPENDENT_COVERAGE.md",
    "docs/ZENODEX_HOST_INDEPENDENT_COVERAGE_V0.json",
    "docs/ZENODEX_PROOF_SUBSTRATE_OBLIGATIONS_V0.json",
    "docs/ZENODEX_TRANSITION_PROFILE_CLOSURE_V0.json",
    "docs/ZENODEX_CRITICAL_VALUE_SURFACE_INVENTORY_V0.json",
    "docs/ZENODEX_ZK_PERFORMANCE_SNAPSHOT_2026_05_31.md",
    "docs/ZENODEX_ZK_PERFORMANCE_SNAPSHOT_2026_05_31.json",
    ...
    "tests/tools/test_check_zenodex_batch_proof_coverage.py",
    "tests/tools/test_check_zenodex_host_independent_coverage.py",
    "tests/tools/test_check_zenodex_proof_substrate_obligations.py",
    "tests/tools/test_check_zenodex_transition_profile_closure.py",
    "tests/tools/test_check_zenodex_critical_value_surface_inventory.py",
    "tests/tools/test_measure_zenodex_zk_transition_coverage.py",
    "tools/check_derivatives_evidence_manifest.py",
    "tools/check_zenodex_batch_proof_coverage.py",
    "tools/check_zenodex_host_independent_coverage.py",
    "tools/check_zenodex_proof_substrate_obligations.py",
    "tools/check_zenodex_transition_profile_closure.py",
    "tools/check_zenodex_critical_value_surface_inventory.py",
    ...
    "tools/measure_zenodex_zk_transition_coverage.py",
