...
def main() -> None:
    ...
    print("pool-mutating tx (writer OR other route). For route-writer conflicts,")
    print("same-sender prior writers block lifting. For route-route conflicts,")
    print("the scheduler selects one route to win; the other is rejected")
    print("(worst-position: n_routes-1 other routes execute first).")
    print("")
    print("The rejection rate depends on same-sender prefix ordering,")
    print("route-route pool sharing, and scheduler behavior in")
