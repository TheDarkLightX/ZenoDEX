/-!
# ZenoDEX Exact-Out Route Certificate

This file formalizes the deterministic shell around the exact-out route
...
This proof models the Tau-visible key ranks, not the full Python exact-out
route-key construction. The shipped runtime is still responsible for mapping the
exact route key

`(amount_in_total, leg_count, legs_lex)`
...
namespace TauSwap
namespace Routing
namespace ExactOutRouteCertificate
