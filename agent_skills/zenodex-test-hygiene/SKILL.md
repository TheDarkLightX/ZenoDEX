...
pytest -q tests/test_check_test_hygiene_v1.py tests/test_run_test_hygiene_gate_v1.py
```

## Reporting

Report the invariant, changed critical paths, packet ID, named negative or
mutant, commands and outcomes, unrun gates, and residual risk. A green hygiene
gate means the declared evidence is current and executable. It does not promote
production readiness or whole-economy correctness.
