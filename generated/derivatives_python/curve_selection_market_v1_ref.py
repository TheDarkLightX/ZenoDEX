...
class Command:
    """Command to execute."""
    tag: Literal('admin_set_interval', 'advance_epoch', 'settle_prediction', 'stake_on_curve', 'unstake')
...
def check_invariants(s: State) -> tuple[bool, str | None]:
    ...
    if not (isinstance(s.active_curve, int) and not isinstance(s.active_curve, bool) and 0 <= s.active_curve <= 4):
        return False, 'domain_active_curve'
    if not (isinstance(s.epochs_since_start, int) and not isinstance(s.epochs_since_start, bool) and 0 <= s.epochs_since_start <= 1000000000):
        return False, 'domain_epochs_since_start'
    if not (isinstance(s.prediction_epoch, int) and not isinstance(s.prediction_epoch, bool) and 0 <= s.prediction_epoch <= 1000000000):
    ...
    if not (isinstance(s.revenue_0, int) and not isinstance(s.revenue_0, bool) and 0 <= s.revenue_0 <= 1000000000000):
        return False, 'domain_revenue_0'
    if not (isinstance(s.revenue_1, int) and not isinstance(s.revenue_1, bool) and 0 <= s.revenue_1 <= 1000000000000):
        return False, 'domain_revenue_1'
    if not (isinstance(s.revenue_2, int) and not isinstance(s.revenue_2, bool) and 0 <= s.revenue_2 <= 1000000000000):
        return False, 'domain_revenue_2'
    if not (isinstance(s.revenue_3, int) and not isinstance(s.revenue_3, bool) and 0 <= s.revenue_3 <= 1000000000000):
        return False, 'domain_revenue_3'
    if not (isinstance(s.revenue_4, int) and not isinstance(s.revenue_4, bool) and 0 <= s.revenue_4 <= 1000000000000):
        return False, 'domain_revenue_4'
    if not (isinstance(s.settlement_epoch_interval, int) and not isinstance(s.settlement_epoch_interval, bool) and 1 <= s.settlement_epoch_interval <= 1000):
        return False, 'domain_settlement_epoch_interval'
    if not (isinstance(s.stakes_0, int) and not isinstance(s.stakes_0, bool) and 0 <= s.stakes_0 <= 1000000000000):
        return False, 'domain_stakes_0'
    if not (isinstance(s.stakes_1, int) and not isinstance(s.stakes_1, bool) and 0 <= s.stakes_1 <= 1000000000000):
        return False, 'domain_stakes_1'
    if not (isinstance(s.stakes_2, int) and not isinstance(s.stakes_2, bool) and 0 <= s.stakes_2 <= 1000000000000):
        return False, 'domain_stakes_2'
    if not (isinstance(s.stakes_3, int) and not isinstance(s.stakes_3, bool) and 0 <= s.stakes_3 <= 1000000000000):
        return False, 'domain_stakes_3'
    if not (isinstance(s.stakes_4, int) and not isinstance(s.stakes_4, bool) and 0 <= s.stakes_4 <= 1000000000000):
        return False, 'domain_stakes_4'
    if not (isinstance(s.total_staked, int) and not isinstance(s.total_staked, bool) and 0 <= s.total_staked <= 1000000000000):
        return False, 'domain_total_staked'
    if not (isinstance(s.winner_payout_pool, int) and not isinstance(s.winner_payout_pool, bool) and 0 <= s.winner_payout_pool <= 1000000000000):
    ...
    if not (((s.stakes_0 >= 0) and (s.stakes_1 >= 0) and (s.stakes_2 >= 0) and (s.stakes_3 >= 0) and (s.stakes_4 >= 0))):
        return False, 'inv_stakes_nonneg'
    if not ((((((s.stakes_0 + s.stakes_1) + s.stakes_2) + s.stakes_3) + s.stakes_4) == s.total_staked)):
...
def step(s: State, cmd: Command) -> StepResult:
    ...
    if cmd.tag == 'admin_set_interval':
        if 'new_interval' not in cmd.args or not (isinstance(cmd.args['new_interval'], int) and not isinstance(cmd.args['new_interval'], bool) and 1 <= cmd.args['new_interval'] <= 1000):
        ...
        if 'revenue_delta_0' not in cmd.args or not (isinstance(cmd.args['revenue_delta_0'], int) and not isinstance(cmd.args['revenue_delta_0'], bool) and 0 <= cmd.args['revenue_delta_0'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param revenue_delta_0')
        if 'revenue_delta_1' not in cmd.args or not (isinstance(cmd.args['revenue_delta_1'], int) and not isinstance(cmd.args['revenue_delta_1'], bool) and 0 <= cmd.args['revenue_delta_1'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param revenue_delta_1')
        if 'revenue_delta_2' not in cmd.args or not (isinstance(cmd.args['revenue_delta_2'], int) and not isinstance(cmd.args['revenue_delta_2'], bool) and 0 <= cmd.args['revenue_delta_2'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param revenue_delta_2')
        if 'revenue_delta_3' not in cmd.args or not (isinstance(cmd.args['revenue_delta_3'], int) and not isinstance(cmd.args['revenue_delta_3'], bool) and 0 <= cmd.args['revenue_delta_3'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param revenue_delta_3')
        if 'revenue_delta_4' not in cmd.args or not (isinstance(cmd.args['revenue_delta_4'], int) and not isinstance(cmd.args['revenue_delta_4'], bool) and 0 <= cmd.args['revenue_delta_4'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param revenue_delta_4')
        if not (((s.epochs_since_start < 1000000000) and ((cmd.args['revenue_delta_0'] + s.revenue_0) <= 1000000000000) and ((cmd.args['revenue_delta_1'] + s.revenue_1) <= 1000000000000) and ((cmd.args['revenue_delta_2'] + s.revenue_2) <= 1000000000000) and ((cmd.args['revenue_delta_3'] + s.revenue_3) <= 1000000000000) and ((cmd.args['revenue_delta_4'] + s.revenue_4) <= 1000000000000))):
        ...
        if 'winning_curve_id' not in cmd.args or not (isinstance(cmd.args['winning_curve_id'], int) and not isinstance(cmd.args['winning_curve_id'], bool) and 0 <= cmd.args['winning_curve_id'] <= 4):
            return StepResult(ok=False, error='invalid param winning_curve_id')
        if 'protocol_fee' not in cmd.args or not (isinstance(cmd.args['protocol_fee'], int) and not isinstance(cmd.args['protocol_fee'], bool) and 0 <= cmd.args['protocol_fee'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param protocol_fee')
        if not (((s.prediction_epoch < 1000000000) and ((cmd.args['protocol_fee'] + s.protocol_fee_pool) <= 1000000000000) and (cmd.args['protocol_fee'] <= (s.total_staked - (s.stakes_0 if (0 == cmd.args['winning_curve_id']) else (s.stakes_1 if (1 == cmd.args['winning_curve_id']) else (s.stakes_2 if (2 == cmd.args['winning_curve_id']) else (s.stakes_3 if (3 == cmd.args['winning_curve_id']) else s.stakes_4)))))) and (s.epochs_since_start >= s.settlement_epoch_interval))):
        ...
        new_state = State(
            ...
            total_staked=(s.stakes_0 if (0 == cmd.args['winning_curve_id']) else (s.stakes_1 if (1 == cmd.args['winning_curve_id']) else (s.stakes_2 if (2 == cmd.args['winning_curve_id']) else (s.stakes_3 if (3 == cmd.args['winning_curve_id']) else s.stakes_4)))),
            winner_payout_pool=((s.total_staked - (s.stakes_0 if (0 == cmd.args['winning_curve_id']) else (s.stakes_1 if (1 == cmd.args['winning_curve_id']) else (s.stakes_2 if (2 == cmd.args['winning_curve_id']) else (s.stakes_3 if (3 == cmd.args['winning_curve_id']) else s.stakes_4))))) - cmd.args['protocol_fee']),
        )
        effects = {
        ...
        if 'curve_id' not in cmd.args or not (isinstance(cmd.args['curve_id'], int) and not isinstance(cmd.args['curve_id'], bool) and 0 <= cmd.args['curve_id'] <= 4):
        ...
        if 'auth_ok' not in cmd.args or not (isinstance(cmd.args['auth_ok'], bool)):
            return StepResult(ok=False, error='invalid param auth_ok')
        if not ((((cmd.args['amount'] + s.total_staked) <= 1000000000000) and cmd.args['auth_ok'])):
        ...
        new_state = State(
            ...
            revenue_4=s.revenue_4,
            settlement_epoch_interval=s.settlement_epoch_interval,
            stakes_0=((cmd.args['amount'] + s.stakes_0) if (0 == cmd.args['curve_id']) else s.stakes_0),
            stakes_1=((cmd.args['amount'] + s.stakes_1) if (1 == cmd.args['curve_id']) else s.stakes_1),
            stakes_2=((cmd.args['amount'] + s.stakes_2) if (2 == cmd.args['curve_id']) else s.stakes_2),
            stakes_3=((cmd.args['amount'] + s.stakes_3) if (3 == cmd.args['curve_id']) else s.stakes_3),
            stakes_4=((cmd.args['amount'] + s.stakes_4) if (4 == cmd.args['curve_id']) else s.stakes_4),
        ...
        if 'amount' not in cmd.args or not (isinstance(cmd.args['amount'], int) and not isinstance(cmd.args['amount'], bool) and 1 <= cmd.args['amount'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param amount')
        if 'penalty_amount' not in cmd.args or not (isinstance(cmd.args['penalty_amount'], int) and not isinstance(cmd.args['penalty_amount'], bool) and 0 <= cmd.args['penalty_amount'] <= 1000000000000):
            return StepResult(ok=False, error='invalid param penalty_amount')
        if 'auth_ok' not in cmd.args or not (isinstance(cmd.args['auth_ok'], bool)):
            return StepResult(ok=False, error='invalid param auth_ok')
        if not ((((cmd.args['penalty_amount'] + s.protocol_fee_pool) <= 1000000000000) and (cmd.args['amount'] <= (s.stakes_0 if (0 == cmd.args['curve_id']) else (s.stakes_1 if (1 == cmd.args['curve_id']) else (s.stakes_2 if (2 == cmd.args['curve_id']) else (s.stakes_3 if (3 == cmd.args['curve_id']) else s.stakes_4))))) and (cmd.args['penalty_amount'] <= cmd.args['amount']) and cmd.args['auth_ok'])):
        ...
        new_state = State(
            ...
            revenue_4=s.revenue_4,
            settlement_epoch_interval=s.settlement_epoch_interval,
            stakes_0=((s.stakes_0 - cmd.args['amount']) if (0 == cmd.args['curve_id']) else s.stakes_0),
            stakes_1=((s.stakes_1 - cmd.args['amount']) if (1 == cmd.args['curve_id']) else s.stakes_1),
            stakes_2=((s.stakes_2 - cmd.args['amount']) if (2 == cmd.args['curve_id']) else s.stakes_2),
            stakes_3=((s.stakes_3 - cmd.args['amount']) if (3 == cmd.args['curve_id']) else s.stakes_3),
            stakes_4=((s.stakes_4 - cmd.args['amount']) if (4 == cmd.args['curve_id']) else s.stakes_4),
