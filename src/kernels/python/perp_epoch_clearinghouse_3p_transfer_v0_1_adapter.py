"""Adapter for the `perp_epoch_clearinghouse_3p_transfer_v0_1` kernel spec.
...
IR_HASH = "sha256:255959ed4a949659af69f1f2a8507414d07516773d9dd78f587b941fc957be1c"
...
@dataclass
class PerpEpochClearinghouse3pTransferV0_1Adapter:
    ir: Any
...
def _commit_effect(
    adapter: PerpEpochClearinghouse3pTransferV0_1Adapter,
    effect_id: str,
    value: Any,
) -> None:
...
def _handle_generic(adapter: PerpEpochClearinghouse3pTransferV0_1Adapter, command: Any) -> Any:
    return _kernel_step_ctx(state=adapter._state, command=command, ctx=adapter._ctx)


ACTION_HANDLERS: dict[str, Callable[[PerpEpochClearinghouse3pTransferV0_1Adapter, Any], Any]] = {
    "advance_epoch": _handle_generic,
    "clear_breaker": _handle_generic,
    "deposit_collateral_a": _handle_generic,
    "deposit_collateral_b": _handle_generic,
    "deposit_collateral_c": _handle_generic,
    "publish_clearing_price": _handle_generic,
    "set_position_pair_ab": _handle_generic,
    "set_position_pair_ac": _handle_generic,
    "set_position_pair_bc": _handle_generic,
    "settle_epoch": _handle_generic,
    "withdraw_collateral_a": _handle_generic,
    "withdraw_collateral_b": _handle_generic,
    "withdraw_collateral_c": _handle_generic,
}

EFFECT_HANDLERS: dict[str, Callable[[PerpEpochClearinghouse3pTransferV0_1Adapter, str, Any], None]] = {
    ...
    "collateral_after_c": _commit_effect,
    "fee_pool_after": _commit_effect,
}


def make_adapter(ir: Any) -> PerpEpochClearinghouse3pTransferV0_1Adapter:
    return PerpEpochClearinghouse3pTransferV0_1Adapter(ir=ir)
