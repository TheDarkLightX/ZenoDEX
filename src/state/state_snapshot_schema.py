...
class StateEnumTagV1(Enum):
    ...
    OUTBOX_EFFECT_KIND = "outbox_effect_kind"
    FCIS_REJECTION_PHASE = "fcis_rejection_phase"
    FCIS_REJECTION_CODE = "fcis_rejection_code"
    FCIS_COMMITTED_FAILURE_CODE = "fcis_committed_failure_code"
...
class StateRecordTagV1(Enum):
    ...
    FCIS_TRANSITION_BUDGET = "fcis_transition_budget"
    FCIS_BALANCE_WRITE = "fcis_balance_write"
    FCIS_POOL_WRITE = "fcis_pool_write"
    FCIS_LP_POSITION_VALUE = "fcis_lp_position_value"
    FCIS_LP_POSITION_WRITE = "fcis_lp_position_write"
    FCIS_NONCE_ADVANCE = "fcis_nonce_advance"
    FCIS_FEE_ALLOCATION = "fcis_fee_allocation"
    FCIS_FEE_ACCUMULATOR_WRITE = "fcis_fee_accumulator_write"
    FCIS_VAULT_WRITE = "fcis_vault_write"
    FCIS_ORACLE_WRITE = "fcis_oracle_write"
    FCIS_PERPS_WRITE = "fcis_perps_write"
    FCIS_DEX_PATCH = "fcis_dex_patch"
    FCIS_EFFECTS = "fcis_effects"
    FCIS_NULLIFIER_RECORD = "fcis_nullifier_record"
    FCIS_REPLAY_UPDATE = "fcis_replay_update"
    FCIS_COMMIT_PLAN = "fcis_commit_plan"
    FCIS_REJECTION_PATH_TEXT_PART = "fcis_rejection_path_text_part"
    FCIS_REJECTION_PATH_INDEX_PART = "fcis_rejection_path_index_part"
    FCIS_RECEIPT_BINDING = "fcis_receipt_binding"
    FCIS_ACCEPTANCE_RECEIPT = "fcis_acceptance_receipt"
    FCIS_REJECTION_RECEIPT = "fcis_rejection_receipt"
    FCIS_COMMITTED_FAILURE_RECEIPT = "fcis_committed_failure_receipt"
    FCIS_ACCEPT_DECISION = "fcis_accept_decision"
    FCIS_REJECT_DECISION = "fcis_reject_decision"
    FCIS_COMMITTED_FAILURE_DECISION = "fcis_committed_failure_decision"
