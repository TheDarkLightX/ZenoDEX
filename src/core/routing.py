...
# Quote helpers use ValueError for ordinary domain infeasibility, for example
# too much exact-out demand. Other exceptions indicate a bug or corrupted state
# and must not silently shrink the candidate set.
_CANDIDATE_INFEASIBLE_ERRORS = (ValueError,)
...
def _pool_quote_exact_in(
    ...
    except _CANDIDATE_INFEASIBLE_ERRORS:
        return None
