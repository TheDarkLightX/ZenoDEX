"""Invariant checkers for the versioned v4 perps engine.

This file mirrors the invariants in `src/kernels/dex/perp_epoch_isolated_v4.yaml`.
...
from ..perp_v2.types import Action, ActionParams, EpochPhase, PerpState
