...
_ENDOGENOUS_LP_VALUE_PACKET_BOOL_FIELD_NAMES = (
    "price_provenance_ok",
    "attestation_ok",
    "unique_pool_ids_ok",
...
class SettlementEndogenousLPValuePacket:
    ...
    def __post_init__(self) -> None:
        ...
        for name in _ENDOGENOUS_LP_VALUE_PACKET_BOOL_FIELD_NAMES:
    ...
    def from_dict(cls, payload: Mapping[str, Any]) -> "SettlementEndogenousLPValuePacket":
        ...
        return cls(
            ...
            unique_pool_ids_ok=_require_bool(
                payload.get("unique_pool_ids_ok", False),
                name="unique_pool_ids_ok",
            ),
            all_positive_lp_supply_ok=_require_bool(
                payload.get("all_positive_lp_supply_ok", False),
                name="all_positive_lp_supply_ok",
            ),
            all_assets_priced_ok=_require_bool(
                payload.get("all_assets_priced_ok", False),
                name="all_assets_priced_ok",
            ),
