...
| Replay / idempotency guards — `src/state/nonces.py` | Python | yes | Rust (Phase 6, first expansion) | golden traces incl. duplicate/replayed-tx rejection; differential; rejection tests |
