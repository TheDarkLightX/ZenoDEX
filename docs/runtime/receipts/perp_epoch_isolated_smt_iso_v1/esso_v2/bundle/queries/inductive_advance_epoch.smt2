...
; Query: Inductive check for action 'advance_epoch'
...
(assert (and (<= 1 |p_delta|) (<= |p_delta| 10000)))  ; Param domain

(assert (<= (+ |p_delta| |now_epoch|) 1000000))  ; Guard
...
(assert (= |now_epoch_post| (+ |p_delta| |now_epoch|)))  ; Post now_epoch
