...
; Query: Inductive check for action 'clear_breaker'
...
(assert (and (= true |p_auth_ok|) (= 0 |position_base|) |breaker_active|))  ; Guard

(assert (= |breaker_active_post| false))  ; Post breaker_active
(assert (= |breaker_last_trigger_epoch_post| 0))  ; Post breaker_last_trigger_epoch
