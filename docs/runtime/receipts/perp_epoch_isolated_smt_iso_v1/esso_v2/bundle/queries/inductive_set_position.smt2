...
; Query: Inductive check for action 'set_position'
...
(declare-const |p_new_position_base| Int)
...
(assert (and (<= (- 1000000) |p_new_position_base|) (<= |p_new_position_base| 1000000)))  ; Param domain

(assert (and (ite |breaker_active| (and (ite (= 0 |position_base|) (= 0 |p_new_position_base|) true) (<= (ite (>= |p_new_position_base| 0) |p_new_position_base| (- 0 |p_new_position_base|)) (ite (>= |position_base| 0) |position_base| (- 0 |position_base|))) (or (= 0 |p_new_position_base|) (and (<= |p_new_position_base| 0) (<= |position_base| 0)) (and (>= |p_new_position_base| 0) (>= |position_base| 0)))) (and (ite (= 0 |p_new_position_base|) true (>= |collateral_quote| (ite (= 10000 0) 0 (div (* (ite (= 100000000 0) 0 (div (* (ite (>= |p_new_position_base| 0) |p_new_position_base| (- 0 |p_new_position_base|)) |index_price_e8|) 100000000)) |initial_margin_bps|) 10000)))) (<= (- |now_epoch| |oracle_last_update_epoch|) |max_oracle_staleness_epochs|))) (<= (ite (>= |p_new_position_base| 0) |p_new_position_base| (- 0 |p_new_position_base|)) |max_position_abs|) (= true |p_auth_ok|) |oracle_seen|))  ; Guard
...
(assert (= |entry_price_e8_post| (ite (= 0 |p_new_position_base|) 0 |index_price_e8|)))  ; Post entry_price_e8
...
(assert (= |position_base_post| |p_new_position_base|))  ; Post position_base
