...
; Query: Inductive check for action 'publish_clearing_price'
...
(assert (and (<= 1 |p_price_e8|) (<= |p_price_e8| 1000000000000)))  ; Param domain

(assert (< |clearing_price_epoch| |now_epoch|))  ; Guard
...
(assert (= |clearing_price_e8_post| |p_price_e8|))  ; Post clearing_price_e8
(assert (= |clearing_price_epoch_post| |now_epoch|))  ; Post clearing_price_epoch
(assert (= |clearing_price_seen_post| true))  ; Post clearing_price_seen
