...
; Query: Inductive check for action 'deposit_collateral'
...
(assert (and (<= (+ |p_amount| |collateral_quote|) 1000000000000000) (= true |p_auth_ok|)))  ; Guard
...
(assert (= |collateral_quote_post| (+ |p_amount| |collateral_quote|)))  ; Post collateral_quote
