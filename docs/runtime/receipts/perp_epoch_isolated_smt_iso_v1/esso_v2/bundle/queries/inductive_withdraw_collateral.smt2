...
; Query: Inductive check for action 'withdraw_collateral'
...
(assert (and (<= 1 |p_amount|) (<= |p_amount| 1000000000000)))  ; Param domain

(assert (and (ite (= 0 |position_base|) true (and (<= (- |now_epoch| |oracle_last_update_epoch|) |max_oracle_staleness_epochs|) (>= (- |collateral_quote| |p_amount|) (ite (= 10000 0) 0 (div (* (+ |depeg_buffer_bps| |maintenance_margin_bps|) (ite (= 100000000 0) 0 (div (* (ite (>= |position_base| 0) |position_base| (- 0 |position_base|)) |index_price_e8|) 100000000))) 10000))) |oracle_seen|)) (<= |p_amount| |collateral_quote|) (= true |p_auth_ok|)))  ; Guard
...
(assert (= |collateral_quote_post| (- |collateral_quote| |p_amount|)))  ; Post collateral_quote
