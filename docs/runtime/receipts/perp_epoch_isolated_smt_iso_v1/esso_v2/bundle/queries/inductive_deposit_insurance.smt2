...
; Query: Inductive check for action 'deposit_insurance'
...
(assert (and (<= (+ |p_amount| |initial_insurance|) 1000000000000000) (<= (+ |p_amount| |insurance_balance|) 1000000000000000)))  ; Guard
...
(assert (= |initial_insurance_post| (+ |p_amount| |initial_insurance|)))  ; Post initial_insurance
(assert (= |initial_margin_bps_post| |initial_margin_bps|))  ; Post initial_margin_bps
(assert (= |insurance_balance_post| (+ |p_amount| |insurance_balance|)))  ; Post insurance_balance
