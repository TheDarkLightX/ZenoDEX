...
`docs/runtime/receipts/cbc_runtime_core_kani_v1/`: 66 harnesses on the actual
...
clear-breaker contracts, set-market-params scalar/no-account contracts, and
funding-auto arithmetic).
