...
Results: replay tool accepted `7` bounded scenarios plus `4` deterministic fuzz
...
confidential admission replay/digest drift, plus long-horizon
balance/nonce/atomicity drift.
