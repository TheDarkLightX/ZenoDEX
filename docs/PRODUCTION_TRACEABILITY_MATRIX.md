...
| --- | --- | --- | --- |
| `dex_nonce_replay_protection` | `supported` | Core nonce policy and `apply_ops` nonce admission | `tests/integration/test_dex_engine_helpers.py`, `tests/core/test_dex_step.py` |
