...
| `dependency_pinning_ratchet` | `supported_ratchet` | Release-gate ratchet for unpinned Python requirements and required lock artifact hashes | `tests/integration/test_dependency_pinning_status_check.py`, `tests/test_check_python_hash_locks.py`, `tests/test_check_python_hash_lock_install_surface.py`, `tools/check_dependency_pinning_status.py`, `tools/check_python_hash_locks.py`, `tools/check_python_hash_lock_install_surface.py` |
