...
| `dependency_pinning_ratchet` | `supported_ratchet` | Release-gate ratchet for unpinned Python requirements and required lock artifact hashes | `tests/integration/test_dependency_pinning_status_check.py`, `tools/check_dependency_pinning_status.py` |
