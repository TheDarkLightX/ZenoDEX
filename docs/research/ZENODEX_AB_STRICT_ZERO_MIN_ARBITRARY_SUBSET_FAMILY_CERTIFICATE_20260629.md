...
| `packet_min_amount_out_shape_mismatch` | `False` | `packet_min_amount_out_shape_mismatch` |
| `packet_min_amount_out_non_list` | `False` | `packet_min_amount_out_shape_mismatch` |
| `packet_min_amount_out_non_integer` | `False` | `packet_min_amount_out_shape_mismatch` |
