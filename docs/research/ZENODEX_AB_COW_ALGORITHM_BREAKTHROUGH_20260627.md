...
The core contains bounded exact AB full-state subset DP and exact Hungarian CoW assignment for the uncoupled volume/surplus objective; `ab_cow_exact_solver_envelope_v1.tau` gates the proof surface and rejects overbroad capacity claims.
...
- Fallback after: `12`
- Measured n=8 brute force: `4.178309s`
- Measured n=8 subset DP: `0.022310s`
- Measured n=8 speedup: `187.29x`
...
Core status: exact Hungarian assignment is active for the uncoupled sender-balance economic objective; grouped capacity remains outside the pure matching claim.

- Assignment surface: `uncoupled sender balances`
- Fallback surface: `capacity-coupled grouped senders use greedy/fail-closed path`
- Tie scope: `The assignment path is exact for volume and surplus. It is deterministic, but equal-economic assignments are not claimed byte-identical to the tiny brute-force lexicographic pair-id tie.`
- Measured 6x6 brute force: `0.014012s`
- Measured 6x6 Hungarian assignment: `0.000264s`
- Measured 6x6 speedup: `53.04x`
- Measured 20x20 assignment: `0.006444s`
