...
- Fallback after: `12`
- Measured n=8 brute force: `4.960984s`
- Measured n=8 subset DP: `0.023321s`
- Measured n=8 speedup: `212.72x`
...
Core status: exact Hungarian assignment is active for the uncoupled sender-balance economic objective and now encodes the brute-force lexicographic pair-id tie as a mixed-radix score layer; grouped capacity remains outside the pure matching claim.
...
- Measured 6x6 brute force: `0.014388s`
- Measured 6x6 Hungarian assignment: `0.000345s`
- Measured 6x6 speedup: `41.74x`
- Canonical tie fuzzer: `25` cases, `0` mismatches
- Measured 20x20 assignment: `0.013256s`
