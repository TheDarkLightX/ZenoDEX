# FCIS M6 Luna Explicit Nonclaims

This packet does not claim:

- production readiness or M6 promotion;
- a mounted implementation, authority switch, deployment, or value movement;
- cryptographic authenticity of the external authorization or destination
  verifier adapters;
- authenticated genesis, live signer/quorum policy, production configuration
  freshness, or destination idempotency;
- concrete database atomicity, WAL durability, recovery, CAS, concurrency, or
  crash refinement;
- complete publisher inventory, no-bypass enforcement, or production API
  compatibility;
