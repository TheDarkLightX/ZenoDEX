...
A deterministic stress refuter broadens the strict zero-min host witness packet search and rejects all generated packet mutations under the existing verifier.

Research-only stress evidence; no settlement, state-root, production, or governance authority.

## Evidence Summary

- Deterministic seed: `2026062901`
- Generated cases: `180`
- Strict executable witness packets: `180`
- Valid witness packets: `180`
- Skipped cases: `0`
- Packet mutations checked: `1260`
- Mutation accepts: `0`
...
```bash
python3 tools/check_ab_strict_zero_min_emitter_witness_stress.py
```
