...
| Functions scanned | 5,677 |
| Functions over complexity 5 | 1,605 |
| Functions over 60 lines | 435 |
| Maximum complexity | 763 |
| Maximum function length | 4,021 lines |
...
Next, move `build_exact_out_many_pool_repaired_key_cover_interpretation_packet`
and the remaining exact-out many-pool packet-build and packet-verify endpoints
