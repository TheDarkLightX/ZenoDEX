...
| Functions scanned | 5,693 |
| Functions over complexity 5 | 1,605 |
| Functions over 60 lines | 435 |
| Maximum complexity | 653 |
| Maximum function length | 3,138 lines |
...
Next, move `build_exact_out_many_pool_guarded_quote_packet` and the remaining
