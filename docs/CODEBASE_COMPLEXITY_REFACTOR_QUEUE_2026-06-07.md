...
| Functions scanned | 5,679 |
| Functions over complexity 5 | 1,605 |
| Functions over 60 lines | 435 |
| Maximum complexity | 741 |
| Maximum function length | 3,870 lines |
...
Next, move `build_exact_out_many_pool_certified_advisory_packet` and the
