...
| Maximum complexity | 543 |
| Maximum function length | 2,427 lines |
...
Next, move the remaining exact-out non-many-pool certificate/verifier endpoints
with mutation tests for malformed payloads, verifier-specific errors, fallback
errors, exception payloads, and response metadata.
