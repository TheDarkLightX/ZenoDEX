...
| Functions scanned | 5,689 |
| Functions over complexity 5 | 1,605 |
| Functions over 60 lines | 435 |
| Maximum complexity | 665 |
| Maximum function length | 3,269 lines |
...
2. `src/integration/api_server_exact_out_many_pool_routes.py` handles the
   ...
   `guard_exact_out_many_pool_canonicality`.
...
Next, move `quote_exact_out_many_pool_guarded` and the remaining exact-out
