...
\]
Plain English: the whole system includes execution, guards, certificates,
...
\]
Plain English: the current release claim is narrower than the strongest
...
\]
Plain English: every claim is limited by the strongest public replayable
...
\]
Plain English: bounded candidate families are resolved by explicit total
...
\]
Plain English: the runtime only becomes authoritative after normalization,
...
\]
Plain English: zUSD and perps are covered by explicit bounded public safety
...
\]
Plain English: the release claim is only meaningful if the public replay
...
\]
Plain English: the RC1 claim is configuration-specific, replay-backed, and
explicitly bounded.
