...
\]
Plain English: the system is the conjunction of value-moving execution,
...
\]
Plain English: the public release claim is narrower than the strongest
...
\]
Plain English: a claim may only be stated at the strongest replayable
...
\]
Plain English: canonical winner, proof-carrying packets, bounded risk
...
\]
Plain English: before the execution plane is even allowed to compare route
...
\]
Plain English: on a bounded emitted candidate family, the chosen route or
...
\]
Plain English: reserve-bounded swap execution and exact fee accounting are
...
\]
Plain English: valid batch outcomes must produce canonical winners and
...
\]
Plain English: authority-bearing transitions should only occur when they are
...
\]
Plain English: accepted settlement must carry canonical deltas, bind fills to
...
\]
Plain English: any fact shared across modules must be mirrored and kept
...
\]
Plain English: accepted price material must satisfy freshness limits, source
...
\]
Plain English: the supported public runtime path is a bounded subset of the
...
\]
Plain English: admitted runtime ingress must bind signer, nonce, receipt,
...
\]
Plain English: zUSD actions are only admissible when both balance laws hold,
...
\begin{itemize}
  ...
  monetary semantics.
\end{itemize}
Plain English: zUSD is not one theorem or one Python module. It is a family
...
\]
Plain English: the perps layer relies on explicit oracle freshness, bounded
...
\end{itemize}
Plain English: the perps plane is a bounded risk machine, not a generic
...
\]
Plain English: planning or ranking surfaces may influence what operators look
...
\]
Plain English: a publishable claim requires pinned manifests, tracked replay
...
\end{itemize}
Plain English: the assurance plane itself is stratified.
...
\]
Plain English: RC1 is honest only when the tree is clean, the scope is
...
\end{enumerate}
Plain English: the full system is best reviewed by dependency order rather
