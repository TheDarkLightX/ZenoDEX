...
4. Broader disaster search: close the five explicit frontier blockers currently
   ...
   campaigns now have a public regression projection, with three deferred
   projections requiring source-surface migration before claim promotion.
