...
6. Deeper proof lanes: strengthen ESSO/TLA/LTLf/Morph evidence beyond current
   bounded anchors. The TLA and LTLf lanes now have deterministic bounded
   public replay; external TLC/ESSO model checking and Morph campaign evidence
