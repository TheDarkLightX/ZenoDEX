...
| Reference **loop** + safety property (gate bounds a poisoned PI/Q-table) + `curr`-binding | **Done** (`gov_loop.py`, `test_gov_loop.py`, `test_gov_proposers.py` — 20 tests, empirical) |
