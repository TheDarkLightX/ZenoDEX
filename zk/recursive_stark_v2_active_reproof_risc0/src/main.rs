...
const DEFAULT_INNER_OUTPUT: &str = "/tmp/recursive-stark-active-inner-node-v2.proof.json";
const DEFAULT_ROOT_OUTPUT: &str = "/tmp/recursive-stark-active-epoch-root-v2.proof.json";
// These IDs bind the active anyhow 1.0.103 V1 guest closure. Historical proof
// harnesses retain their older IDs and source closure unchanged.
