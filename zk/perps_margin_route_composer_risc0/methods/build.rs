...
fn write_placeholder(methods_rs: &std::path::Path) {
    let stub = r#"
// Placeholder values are rejected by every proving and verification entry point.
pub const ZENODEX_PERPS_MARGIN_ROUTE_COMPOSER_GUEST_ELF: &[u8] = &[];
pub const ZENODEX_PERPS_MARGIN_ROUTE_COMPOSER_GUEST_ID: [u32; 8] = [0; 8];
"#;
