...
/// Deterministically propose a historical V4 value leaf from bounded
/// disclosures.
///
...
/// the resulting V4 receipt and bind the circular self-image field. Receipt
/// verification plus journal decoding alone does not establish that field.
