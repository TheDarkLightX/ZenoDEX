...
fn run(args: impl IntoIterator<Item = String>) -> Result<String, ReplayError> {
    ...
    serde_json::to_string(&report).map_err(|_| ReplayError::ReportEncoding)
}

fn rejection_report(error: ReplayError) -> String {
    json!({
