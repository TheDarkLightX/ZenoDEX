...
fn run() -> Result<(), String> {
    ...
    let report = serde_json::json!({
        ...
        "guest_elf_bytes": ZENODEX_ZRPF_RISC0_SPOT_VALUE_LEAF_V6_ELF.len(),
        "guest_elf_sha256": sha256_hex(ZENODEX_ZRPF_RISC0_SPOT_VALUE_LEAF_V6_ELF),
        "ok": true,
        ...
        "schema": "zenodex/zrpf_source_opened_spot_value_leaf_v6_proof_report/v1",
