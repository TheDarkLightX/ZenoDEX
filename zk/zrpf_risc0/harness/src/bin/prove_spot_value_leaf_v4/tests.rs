...
use zenodex_zrpf_risc0_verifier::historical_spot_value_leaf_v4::VerifiedSpotValueLeafReceiptErrorV4;
use zenodex_zrpf_risc0_verifier::VerifiedNodeReceiptErrorV3;
