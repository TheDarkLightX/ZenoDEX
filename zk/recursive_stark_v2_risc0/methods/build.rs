...
fn write_placeholder(methods_rs: &std::path::Path) {
    let stub = r#"
// Placeholder methods for host-only tests and linting. Production callers
// reject the empty ELF and all-zero image ID.
pub const TAU_STATE_PROOF_RISC0_AGGREGATE_V2_ELF: &[u8] = &[];
pub const TAU_STATE_PROOF_RISC0_AGGREGATE_V2_ID: [u32; 8] = [0; 8];
"#;
