...
pub fn root(value: u64) -> RootV1 {
    RootV1::parse(
        ...
        "perps margin lane coordinator host test root",
        false,
    )
    .unwrap()
}
...
pub fn module_input(amount_atoms: u128) -> PerpsMarginLaneModuleInputV1 {
    let zero = RootV1::parse(ZERO_ROOT_V1, "perps margin zero root", true).unwrap();
...
pub fn coordinator_input(amount_atoms: u128) -> PerpsMarginLaneCoordinatorGuestInputV1 {
